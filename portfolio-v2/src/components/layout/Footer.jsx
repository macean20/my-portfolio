    ...
    <footer role="contentinfo">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <p>Génie Logiciel · DevOps · Dakar, Sénégal</p>
        </div>
        ...
        <nav className="footer-links" aria-label="Réseaux sociaux">
          ...
          <a href={`mailto:${personal.email}`} className="footer-link" title="Email" aria-label="Email">
            <EmailIcon />
          </a>
        </nav>

        <p className="footer-copy">
          © 2026 <span>{personal.displayName}</span> · ISM Dakar · Fait avec ❤️
        </p>
      </div>
    </footer>
  )
